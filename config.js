...
const defaultOwner = '254753762711';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '254753762711' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '254753762711' ;  // put your number here
